    ...
    QByteArray messageData, QJsonObject & object)
{
     ...
     * of the message (i.e. the first JSON object) seems to always be
     * the previous message which has already been parsed and processed. So here
     * we just get rid of everything but the last message.
